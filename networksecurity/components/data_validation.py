...
class DataValidation:
  ...
  def initaiate_data_validation(self)->DataValidationArtifact:
    try:
      ...
      if not status:
        error_message=f"train dataframe numerical column are missing.\n"
      status=self.is_numerical_columns_exist(dataframe=test_dataframe)
      if not status:
        error_message=f"test dataframe numerical column are missing.\n"
      ...
      data_validaton_artiact=DataValidationArtifact(
